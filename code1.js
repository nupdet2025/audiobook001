...
gdjs.Pagina_9501Code.asyncCallback12664524 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Pagina_9501Code.asyncCallback12664524(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Pagina_9501Code.asyncCallback12666196 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Pagina_9501Code.localVariables);
{gdjs.evtTools.sound.stopSoundOnChannel(runtimeScene, 2);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Pagina_9501Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Pagina_9501Code.asyncCallback12666196(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Pagina_9501Code.eventsList2 = function(runtimeScene) {
...
gdjs.copyArray(runtimeScene.getObjects("before_page"), gdjs.Pagina_9501Code.GDbefore_9595pageObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Pagina_9501Code.GDbefore_9595pageObjects1.length;i<l;++i) {
    if ( gdjs.Pagina_9501Code.GDbefore_9595pageObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Pagina_9501Code.GDbefore_9595pageObjects1[k] = gdjs.Pagina_9501Code.GDbefore_9595pageObjects1[i];
        ++k;
    }
}
gdjs.Pagina_9501Code.GDbefore_9595pageObjects1.length = k;
if (isConditionTrue_0) {
{gdjs.evtTools.sound.fadeSoundVolume(runtimeScene, 2, 0, 0.5);
}
{ //Subevents
gdjs.Pagina_9501Code.eventsList1(runtimeScene);} //End of subevents
}
...
gdjs.copyArray(runtimeScene.getObjects("reload"), gdjs.Pagina_9501Code.GDreloadObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Pagina_9501Code.GDreloadObjects1.length;i<l;++i) {
    if ( gdjs.Pagina_9501Code.GDreloadObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Pagina_9501Code.GDreloadObjects1[k] = gdjs.Pagina_9501Code.GDreloadObjects1[i];
        ++k;
    }
}
gdjs.Pagina_9501Code.GDreloadObjects1.length = k;
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "assets\\Audio_01.mp3", 2, false, 100, 1);
}}
...
gdjs.Pagina_9501Code.eventsList2(runtimeScene);
gdjs.Pagina_9501Code.GDbackgroundObjects1.length = 0;
gdjs.Pagina_9501Code.GDbackgroundObjects2.length = 0;
gdjs.Pagina_9501Code.GDpag_959501_959502Objects1.length = 0;
gdjs.Pagina_9501Code.GDpag_959501_959502Objects2.length = 0;
